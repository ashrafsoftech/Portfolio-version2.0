      ...
      <div className="container-lg">
        ...
        <div className="row mt-5 gap-lg-0 gap-2">
          ...
          <div className="bio col-lg-8 d-lg-grid d-sm-flex d-grid gap-2">
            <div className="card shadow-sm border-0 p-4 h-100 col-lg-12 col-md-6 col-sm-6 reveal">
              <p className="lead text-body-secondary">
                ...
                expand into backend development and become a complete full-stack
                developer.
              </p>
            </div>
            ...
            <div
              id="about-skills"
              className="skills card shadow-sm border-0 p-4 h-100 col-lg-12 col-md-6 text-center reveal"
            >
              <div>
          ...
          <div className="journey card shadow-sm border-0 p-4 h-100 col-lg-4 reveal">
            ...
            <p className="lead text-body-secondary">
              My journey into tech began with curiosity — exploring how websites
              were built and how interactive designs came to life. I started
              learning the basics, building small projects, fixing errors, and
              improving every day. Over time, I developed a strong understanding
              of modern UI development: Creating responsive layouts Writing
              clean and maintainable code Building reusable components in React
              Styling with modern CSS and frameworks Each project pushes me to
              learn more, and I'm constantly expanding my skills with the goal
              of becoming a full-stack engineer.
            </p>
          </div>
        </div>
      </div>
